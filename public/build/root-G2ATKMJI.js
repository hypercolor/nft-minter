...
import {
  buffer_exports,
  init_buffer
} from "/build/_shared/chunk-F2MW2ORK.js";
import {
...
import {
  ...
  Outlet,
  Scripts
} from "/build/_shared/chunk-ER7PLH5W.js";
import {
  createHotContext
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState4 = React23.useState, useEffect10 = React23.useEffect, useLayoutEffect = React23.useLayoutEffect, useDebugValue = React23.useDebugValue;
...
function useMutation(arg1, arg2, arg3) {
  ...
  const [observer] = React4.useState(() => new MutationObserver(queryClient, options));
  React4.useEffect(() => {
    observer.setOptions(options);
  }, [observer, options]);
  const result = useSyncExternalStore(React4.useCallback((onStoreChange) => observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
  const mutate = React4.useCallback((variables, mutateOptions) => {
...
function fallback(transports_, config3 = {}) {
  const { key = "fallback", name = "Fallback", rank = false, retryCount, retryDelay } = config3;
...
function webSocket2(url, config3 = {}) {
  const { key = "webSocket", name = "WebSocket JSON-RPC", retryDelay } = config3;
  return ({ chain, retryCount: retryCount_, timeout: timeout_ }) => {
    const retryCount = config3.retryCount ?? retryCount_;
    const timeout = timeout_ ?? config3.timeout ?? 1e4;
...
`,
  ...
  return {
    ...
    publicClient: ({ chainId }) => {
      const activeChain = chains2.find((x) => x.id === chainId) ?? defaultChains[0];
...
var Config = class {
  constructor({
    ...
    webSocketPublicClient: webSocketPublicClient2
  }) {
  ...
  getWebSocketPublicClient({ chainId } = {}) {
    ...
    if (webSocketPublicClient_)
      return webSocketPublicClient_;
    const { webSocketPublicClient: webSocketPublicClient2 } = this.args;
    webSocketPublicClient_ = typeof webSocketPublicClient2 === "function" ? webSocketPublicClient2({ chainId }) : webSocketPublicClient2;
    if (webSocketPublicClient_)
      this.webSocketPublicClients.set(chainId ?? -1, webSocketPublicClient_);
    return webSocketPublicClient_;
  }
  setWebSocketPublicClient(webSocketPublicClient2) {
    const chainId = this.data?.chain?.id;
    this.args = {
      ...this.args,
      webSocketPublicClient: webSocketPublicClient2
...
addEffects_fn = function() {
  ...
  const { publicClient: publicClient2, webSocketPublicClient: webSocketPublicClient2 } = this.args;
  const subscribePublicClient = typeof publicClient2 === "function";
  const subscribeWebSocketPublicClient = typeof webSocketPublicClient2 === "function";
...
function getPublicClient({ chainId } = {}) {
  const config22 = getConfig();
  if (chainId)
    return config22.getPublicClient({ chainId }) || config22.publicClient;
  return config22.publicClient;
}
function watchPublicClient(args, callback) {
  ...
  const unsubscribe = config22.subscribe(
    ({ publicClient: publicClient2 }) => publicClient2,
    handleChange
  );
  return unsubscribe;
}
...
function WagmiConfig({
  ...
  return React5.createElement(Context.Provider, {
    children: React5.createElement(QueryClientProvider, {
      children,
...
function useConfig() {
  const config3 = React5.useContext(Context);
  if (!config3)
    throw new Error(
      [
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695923685035.025";
}
var LoginForm = () => {
  _s();
  const {
  ...
  if (isConnected) {
    return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { children: ensName ? `${ensName} (${address})` : address }, void 0, false, {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { children: [
    ...
    error && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { children: error.message }, void 0, false, {
      fileName: "app/LoggedOut/LoginForm/index.tsx",
      lineNumber: 66,
      columnNumber: 17
    }, this)
...
_s(LoginForm, "ELRlW0JEM2HgHNhcFgPul+90A7c=", false, function() {
  return [useAccount, useEnsName, useConnect, useDisconnect];
});
_c2 = LoginForm;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695921255669.0466";
}
var LoggedOut = () => {
  const handleLogIn = () => {
  };
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    if (!__privateGet(this, _provider2)) {
      let CoinbaseWalletSDK = (await import("/build/_shared/dist-MO57RZVU.js")).default;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695923702292.2837";
}
if (typeof window !== "undefined") {
  window.Buffer = window.Buffer || (init_buffer(), __toCommonJS(buffer_exports)).Buffer;
}
var {
  chains,
  publicClient,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695921319337.003";
}
function Root() {
  const loggedIn = false;
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=/build/root-G2ATKMJI.js.map
